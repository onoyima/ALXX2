#ifndef _SHELL_FUNC_H_
#define _SHELL_FUNC_H_
...
/**
 *struct passinfomat - contains pseudo-argument to pass into a function,
 *		allowing uniform prototype for function pointer struct
 *@argument: a string generated from getline containing argument
...
{NULL, NULL, NULL, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, \
		0, 0, 0}
/**
 *struct is_builtin_shell - contains a is_builtin_shell string and
 *related function
 *@type: the is_builtin_shell command flag
 *@func: the function
 */
typedef struct is_builtin_shell
{
	char *type;
...
/* shell_0x16 project _shloop.c */
int shell_hash(shell_infomat_t *, char **);
int find_is_builtin_shell(shell_infomat_t *);
void find_command(shell_infomat_t *);
void fork_command(shell_infomat_t *);

/* shell_0x16 project _parser.c */
int is_command(shell_infomat_t *, char *);
char *duplicate_charaters(char *, int, int);
char *find_path(shell_infomat_t *, char *, char *);

/* loopshell_hash.c */
int loopshell_hash(char **);

/* shell_0x16 project _errors.c */
void is_eputs(char *);
